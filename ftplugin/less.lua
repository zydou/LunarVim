...
-- filetype: less
-- server(s): cssls, emmet_language_server, emmet_ls, stylelint_lsp, tailwindcss

-- NOTE: multiple servers manage this filetype; all are attempted
local mgr_ok, mgr = pcall(require, "lvim.lsp.manager")
if mgr_ok then
  pcall(function() mgr.setup('cssls') end)
  pcall(function() mgr.setup('emmet_language_server') end)
  pcall(function() mgr.setup('emmet_ls') end)
  pcall(function() mgr.setup('stylelint_lsp') end)
