...
function _G.get_config_dir()
  ...
  if not lvim_config_dir then return vim.call("stdpath", "config") end
...
function _G.get_cache_dir()
  ...
  if not lvim_cache_dir then return vim.call("stdpath", "cache") end
...
function M:init(base_dir)
  ...
  self.lazy_install_dir = join_paths(base_dir, "plugins", "lazy.nvim")
  ...
  vim.fn.stdpath = function(what)
    if what == "cache" then return _G.get_cache_dir() end
