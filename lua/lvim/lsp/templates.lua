...
local function should_skip(server_name) return vim.tbl_contains(skipped_servers, server_name) end
...
function M.generate_ftplugin(server_name, dir)
  ...
  local filetypes = vim.tbl_filter(function(ft) return not vim.tbl_contains(skipped_filetypes, ft) end, lvim_lsp_utils.get_supported_filetypes(server_name) or {})
