...
if lvim.colorscheme == "lunar" then branch = "%#SLGitIcon#" .. lvim.icons.git.Branch .. "%*" .. "%#SLBranchName#" end

return {
  mode = {
    function() return " " .. lvim.icons.ui.Target .. " " end,
  ...
  treesitter = {
    function() return lvim.icons.ui.Tree end,
    color = function()
  ...
  lsp = {
    function()
      ...
      if copilot_active then language_servers = language_servers .. "%#SLCopilot#" .. " " .. lvim.icons.git.Octoface .. "%*" end
