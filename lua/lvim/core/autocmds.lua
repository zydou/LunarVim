  ...
  local definitions = {
    ...
    },
    {
      "ColorScheme",
      {
        ...
        callback = function()
          if lvim.builtin.breadcrumbs.active then require("lvim.core.breadcrumbs").get_winbar() end
...
local get_format_on_save_opts = function()
  ...
  if type(lvim.format_on_save) ~= "table" then return defaults end
...
function M.enable_format_on_save()
  ...
  vim.api.nvim_create_autocmd("BufWritePre", {
    ...
    callback = function() require("lvim.lsp.utils").format({ timeout_ms = opts.timeout, filter = opts.filter }) end,
  })
...
function M.enable_reload_config_on_save()
  ...
  vim.api.nvim_create_autocmd("BufWritePost", {
    ...
    callback = function() require("lvim.config"):reload() end,
  })
end
