  ...
  lvim.builtin.cmp = {
    ...
    formatting = {
      ...
      format = function(entry, vim_item)
        ...
        if max_width ~= 0 and #vim_item.abbr > max_width then vim_item.abbr = string.sub(vim_item.abbr, 1, max_width - 1) .. lvim.icons.ui.Ellipsis end
...
function M.setup()
  ...
  if lvim.builtin.cmp.on_config_done then lvim.builtin.cmp.on_config_done(cmp) end
end
