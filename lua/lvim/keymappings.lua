...
function M.clear(keymaps)
  ...
  for mode, mappings in pairs(keymaps) do
    ...
    for key, _ in pairs(mappings) do
      ...
      if default[mode][key] ~= nil or (default[translated_mode] ~= nil and default[translated_mode][key] ~= nil) then pcall(vim.api.nvim_del_keymap, translated_mode, key) end
    end
  end
end
...
function M.load_defaults()
  ...
  for idx, _ in pairs(defaults) do
    if not lvim.keys[idx] then lvim.keys[idx] = {} end
  end
end
